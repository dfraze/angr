...
lib.add_number_mapping_from_dict('MIPSO32', {
    4001: "exit",
    4002: "fork",
    4003: "read",
    4004: "write",
...
lib.add_number_mapping_from_dict('MIPS64N32', {
    6000: "read",
    6001: "write",
    6002: "open",
    6003: "close",
...
lib.add_number_mapping_from_dict('SH', {
    0: "restart_syscall",
    1: "exit",
    2: "fork",
    3: "read",
...
lib.add_number_mapping_from_dict('SH64', {
    0: "restart_syscall",
    1: "exit",
    2: "fork",
    3: "read",
...
lib.add_number_mapping_from_dict('ARM64', {
    0: "io_setup",
    1: "io_destroy",
    2: "io_submit",
    3: "io_cancel",
...
lib.add_number_mapping_from_dict('ARMOABI', {
